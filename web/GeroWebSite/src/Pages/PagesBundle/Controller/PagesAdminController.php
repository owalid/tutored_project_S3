...
class PagesAdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('PagesBundle:Administration:layout/index.html.twig', array(
            'pages' => $pages,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('PagesBundle:Administration:layout/new.html.twig', array(
            'page' => $page,
    ...
    public function showAction(Pages $page)
    {
        ...
        return $this->render('PagesBundle:Administration:layout/show.html.twig', array(
            'page' => $page,
    ...
    public function editAction(Request $request, Pages $page)
    {
        ...
        return $this->render('PagesBundle:Administration:layout/edit.html.twig', array(
            'page' => $page,
